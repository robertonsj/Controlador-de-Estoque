...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MasterControl");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Fazer o controle das vendas ficou muito mais fácil!");
    ...
    private void btnentrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnentrarActionPerformed
        ...
        try {
            ...
            FuncionarioDadosTratados dadostd = new FuncionarioDadosTratados();
            dadostd.efetuarLogin(email, senha);

            //fechar o formulário, mas sem sair do sistema
            this.dispose();
